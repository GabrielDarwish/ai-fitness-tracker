        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-10 shadow-xl">
          ...
          {error && (
            <div className="mb-6 rounded-lg border border-red-200 bg-red-50 p-4">
              <p className="text-sm leading-relaxed text-red-700">
                {error === "OAuthSignin" && "Unable to connect. Please try again."}
                {error === "OAuthCallback" && "Authentication failed. Please try again."}
                {error === "OAuthCreateAccount" && "Could not create account."}
                {error === "OAuthAccountNotLinked" && "Email already registered."}
                {error === "SessionRequired" && "Please sign in to continue."}
                {!["OAuthSignin", "OAuthCallback", "OAuthCreateAccount", "OAuthAccountNotLinked", "SessionRequired"].includes(error) && 
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-lg border-2 border-slate-200 bg-white px-6 py-3.5 text-sm font-semibold text-slate-700 shadow-sm transition-all duration-200 hover:border-slate-300 hover:bg-slate-50 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
            >
              {!isLoadingGoogle && (
          ...
          <div className="space-y-3 text-center">
            ...
            <p className="text-xs leading-relaxed text-slate-600">
              AI-powered insights to help you reach your fitness goals
            </p>
          </div>
        </div>
